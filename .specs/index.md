...
Catalog for agents and humans. **Default agent entry:** [`AGENTS.md`](../AGENTS.md).

| Path | Audience | Status | Last verified |
| --- | --- | --- | --- |
| `AGENTS.md` | Agent | Active | 2026-05-29 |
...
| `.specs/features/active/m6.1-multi-currency-follow-ups/` | Agent | Active — execute next | 2026-05-31 |
...
| `.specs/features/completed/m4-v1-polish/` | Archive | Shipped | 2026-05-28 |
| `README.md` | Human | Active — excluded from Cursor index | 2026-05-28 |
| `bruno/investment-tracker-api/README.md` | Human | Active — excluded from index | 2026-05-28 |
| `.cursor/JIRA-MCP.md` | Human + agent (Jira tasks) | Active — excluded from index | 2026-05-29 |
